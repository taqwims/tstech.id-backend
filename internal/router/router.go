...
func Setup(e *echo.Echo, h *Handlers) {
	...
	client.GET("/projects/:id/bast", h.Client.GetBast)
	client.POST("/projects/:id/bast", h.Client.SaveBast)
	...
	admin.GET("/projects/:id/bast", h.Admin.GetBast)
	admin.POST("/projects/:id/bast", h.Admin.SaveBast)
